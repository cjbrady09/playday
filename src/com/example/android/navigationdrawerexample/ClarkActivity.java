...
public class ClarkActivity extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        mp = MediaPlayer.create(this, R.raw.farmer);
		mp.start();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clark);
	...
	{
		Intent i = new Intent(getBaseContext(), BunnyActivity.class);   
		startActivity(i);
	}
