...
public class KatieCaraActivity extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        mp = MediaPlayer.create(this, R.raw.country);
		mp.start();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katie_cara);
	...
	{
		Intent i = new Intent(getBaseContext(), ClarkActivity.class);   
		startActivity(i);
	}
