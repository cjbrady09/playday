...
public class AlbiaActivity extends Activity {
    ...
    protected void onResume() {
        super.onResume();
        mp = MediaPlayer.create(this, R.raw.heartland);
		mp.start();
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_albia);
	...
	{
		Intent i = new Intent(getBaseContext(), BradyActivity.class);   
		startActivity(i);
	}
